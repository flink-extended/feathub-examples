...
if __name__ == "__main__":
    ...
    s3_sink = FileSystemSink(path="s3://feathub-test/output", data_format="json")

    result_table.execute_insert(sink=s3_sink, allow_overwrite=True).wait()
